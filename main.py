...
def create_post(new_post: Post):
    print(
        new_post.title
    )  # this will return only title, like we can take single property of the model as well
    print(
        new_post
    )  # this will print both title and content which we passed in our basemodel
